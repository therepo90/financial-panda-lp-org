...
$(window).on("load", function () {
  ...
  $.scrollIt({
    easing: 'swing',
    // funkcja wygładzania animacji
    scrollTime: 900,
    // jak długo (w ms) trwa animacja
    activeClass: 'active',
    // klasa przypisana do aktywnego elementu nawigacji
    onPageChange: null,
    // funkcja(pageIndex) wywoływana po zmianie strony
    topOffset: -63
  });
});
},{}]},{},["imtx"], null)